                ...
                var columns = [
                ...
                
                    {
                        ...
                        render: function (data) {
                            ...
                            resultSnc += '<a class="dropdown-item edit" id="' + data + '" data-toggle="modal" data-target="#mainModal" onclick="btnClick(this)">Proje Düzenle </a>';
...
function btnClick(obj) {
    if (obj.className.includes("insert")) {
        document.getElementById("modalTitle").innerHTML = "Proje Ekle";
        document.getElementById("btnSumbit").innerHTML = "Yeni Proje Kaydet";
        FormClean();
    }
    else if (obj.className.includes("edit")) {
        document.getElementById("modalTitle").innerHTML = "Proje Güncelleme";
        document.getElementById("btnSumbit").innerHTML = "Proje Güncelle";
        Find(obj.id);
    }
}
function FormClean() {
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.state) {
                ...
                document.getElementById("Meters").value = data.data.Meters;
                document.getElementById("ProjectDate").value = data.data.ProjectDate;
...
function PostData(obj) {
    ...
    categories.Location = document.getElementById("Location").value;
    categories.Meters = document.getElementById("Meters").value ;
    categories.ProjectDate = document.getElementById("ProjectDate").value;
            ...
            success: function (data) {
                if (data.state) {
                    ...
                    Swal.fire({
                        ...
                        text: "Proje başarıyla güncellenmiştir.",
                        type: "success"
                    })
                    PageLoad();
                }
                    ...
                    Swal.fire({
                        title: "Proje Güncelleme!",
                        text: "Proje bilgilerini lütfen kontrol ediniz. İşlem tamamlanamadı",
                        type: "warning"
                    })
                }
            }
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.state) {
                    ...
                    Swal.fire("Proje Günceleme!", x.message, "warning");
                }
            },
            error: function (x) {
                Swal.fire("Proje Günceleme!", x.message, "error");
            }
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.state) {
                    ...
                    Swal.fire("Proje Ekleme!", x.message, "warning");
                }
            },
            error: function (x) {
                Swal.fire("Proje Ekleme!", x.message, "error");
            }
        });
    }
}
